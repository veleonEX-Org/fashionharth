...
export class PaymentService {
    ...
    async initiateCheckout(options, provider = 'stripe') {
    ...
    async createInstallmentPlan(userId, totalAmount, periods, provider = 'stripe', itemId) {
        ...
        const transactionResult = await pool.query("INSERT INTO transactions (user_id, amount, currency, status, type, provider) VALUES ($1, $2, $3, $4, $5, $6) RETURNING id", [userId, totalAmount, 'USD', 'pending', 'installment', provider]);
        ...
        for (let i = 1; i <= periods; i++) {
            ...
            await pool.query("INSERT INTO installments (transaction_id, installment_number, total_installments, amount, due_date, status) VALUES ($1, $2, $3, $4, $5, $6)", [transactionId, i, periods, installmentAmount, dueDate, 'pending']);
        }
        const activeProvider = this.getProvider(provider);
