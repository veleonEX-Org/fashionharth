...
// ============ MEASUREMENT FIELDS ============
export async function getMeasurementFields(_req, res, next) {
    try {
...
export async function getMeasurementField(req, res, next) {
    try {
        const id = parseInt(req.params.id, 10);
...
export async function createMeasurementField(req, res, next) {
    try {
...
export async function updateMeasurementField(req, res, next) {
    try {
        const id = parseInt(req.params.id, 10);
...
export async function deleteMeasurementField(req, res, next) {
    try {
        const id = parseInt(req.params.id, 10);
