      ...
      <div className="prose prose-invert prose-lg max-w-none space-y-12">
        <section>
          ...
          <p className="text-gray-300">
            Welcome to Veleonex Starter. We respect your privacy and are committed to protecting your personal data. 
        ...
        <section>
          ...
          <p className="text-gray-300">
            ...
            <a href="mailto:privacy@veleonex.com" className="text-primary hover:underline">privacy@veleonex.com</a>
          </p>
        </section>
      </div>
    </div>
