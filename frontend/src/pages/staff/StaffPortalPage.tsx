  ...
  return (
    <div className="space-y-6">
       <div className="flex items-center justify-between border-b border-border pb-4">
          <div>
             <h1 className="text-2xl font-bold text-foreground">Staff Production Portal</h1>
             <p className="text-sm text-muted-foreground">Manage your assigned production assignments.</p>
          </div>
               ...
               >
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                     <div className="space-y-1">
                        <div className="text-xs font-bold text-primary uppercase tracking-widest">{t.category}</div>
